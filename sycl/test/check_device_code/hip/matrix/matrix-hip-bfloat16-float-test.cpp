...
row_row_m16n16k16(sycl::accessor<bfloat16, 1, sycl::access::mode::read_write,
  ...
  // GFX90A: tail call <4 x float> @llvm.amdgcn.mfma.f32.16x16x16bf16.1k
  // GFX11: call {{.*}}<8 x float> @llvm.amdgcn.wmma.f32.16x16x16.bf16
...
row_col_m32n32k8(sycl::accessor<bfloat16, 1, sycl::access::mode::read_write,
  ...
  // GFX90A: tail call <16 x float> @llvm.amdgcn.mfma.f32.32x32x8bf16.1k
  joint_matrix_mad(sg, sub_c, sub_a, sub_b, sub_c);
  joint_matrix_store(sg, sub_c,
