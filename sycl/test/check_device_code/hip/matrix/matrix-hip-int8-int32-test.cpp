...
row_row_m16n16k16(sycl::accessor<int8_t, 1, sycl::access::mode::read_write,
  ...
  // GFX90A: tail call <4 x i32> @llvm.amdgcn.mfma.i32.16x16x16i8
  // GFX11: call {{.*}}<8 x i32> @llvm.amdgcn.wmma.i32.16x16x16.iu8
...
row_col_m32n32k8(sycl::accessor<int8_t, 1, sycl::access::mode::read_write,
  ...
  // GFX90A: tail call <16 x i32> @llvm.amdgcn.mfma.i32.32x32x8i8
  joint_matrix_mad(sg, sub_c, sub_a, sub_b, sub_c);
  joint_matrix_store(sg, sub_c,
